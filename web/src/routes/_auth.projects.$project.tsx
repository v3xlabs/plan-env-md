...
import { addAlias, projectsQueryOptions, removeAlias, setFavicon } from "../api/projects";
...
const Aliases = (properties: { project: string; aliases: string[]; }) => {
  ...
  return (
    <div class="border-t border-line pt-3">
      <p class="mb-2 font-mono text-xs tracking-wide text-muted uppercase">Also known as</p>
    ...
    <div>
      <div class="mb-8 flex items-center gap-3">
        <button
          ...
          title="Project icon"
          class="shrink-0 rounded hover:opacity-70"
        >
          <ProjectFavicon project={parameters().project} has={hasIcon()} class="size-9" />
        </button>
        <div class="min-w-0 flex-1">
      ...
      <Modal title="Project settings" isOpen={isSettingsOpen()} onOpenChange={setSettingsOpen}>
        <div class="space-y-3">
          ...
          <p class="text-xs text-muted">PNG, SVG, WebP, GIF or ICO, up to 64 KB.</p>
